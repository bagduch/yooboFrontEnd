        ...
        <card-component :title="formCardTitle" icon="account-edit" class="tile is-child">
          <form @submit.prevent="submit">
            ...
            <b-field label="Unit/Flat No." message="Your Unit/Flat No." horizontal>
              <b-input placeholder="e.g. Unit 10" v-model="form.number" name="number" required/>
            </b-field>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                this.form.first_name = this.userFirstName;
            },
            ...
            submit() {
                ...
                axios({
                    ...
                    if (!this.id && r.data.data.id) {
                        this.$router.push({name: 'user.edit', params: {id: r.data.data.id}})
